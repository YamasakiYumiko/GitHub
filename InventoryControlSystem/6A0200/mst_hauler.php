<?php
	...
	if ($order_by == null) {
		$order_by = "m.hauler_cd";
	}

	$mst_cd1 = (string) @$_POST['mst_cd1'];
	$mst_cd2 = (string) @$_POST['mst_cd2'];

	$hauler_name1 = (string) @$_POST['hauler_name1'];
...
QUERY_EOD;
	...
	if ($mst_cd1 != '' && $mst_cd2 != '') {
		...
		AND m.hauler_cd BETWEEN '$mst_cd1' AND '$mst_cd2'
QUERY_EOD;
	} else if ($mst_cd1 != '') {
		$query = $query . <<<QUERY_EOD
		AND m.hauler_cd >= '$mst_cd1'
QUERY_EOD;
	} else if ($mst_cd2 != '') {
		$query = $query . <<<QUERY_EOD
		AND m.hauler_cd <= '$mst_cd2'
QUERY_EOD;
}
	...
	if ($hauler_name1 != '') {
		$query = $query . <<<QUERY_EOD
		AND m.hauler_name LIKE '%$hauler_name1%'
QUERY_EOD;
	}
?>
					...
					<table style="border-style: none">
						<tr>
							...
							<td><input type="text" name="mst_cd1" value="<?php echo $mst_cd1; ?>" maxlength="4" onkeypress="return EnterFocusCD(this, 'mst_cd2', 'mst_cd1', '', 4, true)" onblur="return FocusCD(this, 'mst_cd2', 'mst_cd1', '', 4, true)" />
								~
								<input type="text" name="mst_cd2" value="<?php echo $mst_cd2; ?>" maxlength="4" onkeypress="return EnterFocusCD(this, 'hauler_name1', 'mst_cd2', '', 4, true)" onblur="return FocusCD(this, 'hauler_name1', 'mst_cd2', '', 4, true)" /></td>
							<th>配送業者名</th>
							<td><input type="text" name="hauler_name1" value="<?php echo $hauler_name1; ?>" onkeypress="return EnterFocus(this, 'interval')" /></td>
						</tr>
						<tr>
							<th>表示件数</th>
