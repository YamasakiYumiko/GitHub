					...
					<table style="border-style: none">
						<tr>
							...
							<td><input type="text" name="mst_cd1" value="<?php echo $mst_cd1; ?>" maxlength="10" onkeypress="return EnterFocusCD(this, 'mst_cd2', 'mst_cd1', '', 10, true)" onblur="return FocusCD(this, 'mst_cd2', 'mst_cd1', '', 10, true)" />
								~
								<input type="text" name="mst_cd2" value="<?php echo $mst_cd2; ?>" maxlength="10" onkeypress="return EnterFocusCD(this, 'supplier_name1', 'mst_cd2', '', 10, true)" onblur="return FocusCD(this, 'supplier_name1', 'mst_cd2', '', 10, true)" /></td>
							<th>仕入先名</th>
						...
						if (! $res) {
							...
							for($count = 0; $count < count ( $m_arr2 ); $count ++) {
								if ($m_arr2 [$count] == "") {
									...
									echo "<th>" . $m_arr2 [$count] . "<br><button type=\"submit\" name=\"order_by\" value=\"m2." . "staff_name" . "\">↓</button><button type=\"submit\" name=\"order_by\" value=\"m2." . "staff_name" . " DESC\">↑</button></th>";
								} else if ($m_arr1 [$count] == "stock_office_name") {
									echo "<th>" . $m_arr2 [$count] . "<br><button type=\"submit\" name=\"order_by\" value=\"m3." . "office_name" . "\">↓</button><button type=\"submit\" name=\"order_by\" value=\"m3." . "office_name" . " DESC\">↑</button></th>";
								} else if ($m_arr1 [$count] == "tel" || $m_arr1 [$count] == "fax") {
									echo "<th>" . $m_arr2 [$count] . "<br><button type=\"submit\" name=\"order_by\" value=\"m." . $m_arr1 [$count] . "1_1, m." . $m_arr1 [$count] . "1_2, m." . $m_arr1 [$count] . "1_3\">↓</button><button type=\"submit\" name=\"order_by\" value=\"m." . $m_arr1 [$count] . "1_1 DESC, m." . $m_arr1 [$count] . "1_2 DESC, m." . $m_arr1 [$count] . "1_3 DESC\">↑</button></th>";
								} else {
