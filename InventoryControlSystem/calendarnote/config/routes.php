 ...
 */
  // mobile
	Router::connect('/m/', array('controller' => 'schedules', 'action' => 'index', 'prefix' => 'mobile', 'mobile' => true));
	Router::connect('/m/users/:action', array('controller' => 'users', 'prefix' => 'mobile', 'mobile' => true));
/**
