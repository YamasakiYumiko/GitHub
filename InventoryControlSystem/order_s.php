						...
						<tr>
							...
							<td>
								...
								~ <input type="text" name="item_cd2"
									...
									onkeypress="return EnterFocusCD(this, 'order_ymd1', 'item_cd2', 'D', 7, false)"
									onblur="return FocusCD(this, 'order_ymd1', 'item_cd2', 'D', 7, false)" />
							</td>
						</tr>
						<tr>
							<th>発注日</th>
					...
					<?php
						foreach ( $conn_array as $key => $value ) {
							...
							if (! $res) {
								...
								echo "<tr>";
								echo "<th></th>";
								echo "<th>伝票番号<br><button type=\"submit\" name=\"order_by\" value=\"o.order_slip_no ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.order_slip_no DESC\">↑</button></th>";
								// echo "<th>発注区分<br><button type=\"submit\" name=\"order_by\" value=\"o.order_kbn ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.order_kbn DESC\">↑</button></th>";
								// echo "<th>事業所CD<br><button type=\"submit\" name=\"order_by\" value=\"o.office_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.office_cd DESC\">↑</button></th>";
								// echo "<th>倉庫CD<br><button type=\"submit\" name=\"order_by\" value=\"o.warehouse_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.warehouse_cd DESC\">↑</button></th>";
								...
								echo "<th>発注日<br><button type=\"submit\" name=\"order_by\" value=\"o.order_ymd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.order_ymd DESC\">↑</button></th>";
								// echo "<th>入荷予定日<br><button type=\"submit\" name=\"order_by\" value=\"o.arrival_ex_ymd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.arrival_ex_ymd DESC\">↑</button></th>";
								// echo "<th>仕入予定日<br><button type=\"submit\" name=\"order_by\" value=\"o.purchase_ex_ymd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.purchase_ex_ymd DESC\">↑</button></th>";
								echo "<th>入荷予定日<br><button type=\"submit\" name=\"order_by\" value=\"od.purchase_ex_ymd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.purchase_ex_ymd DESC\">↑</button></th>";
								// echo "<th>担当者CD<br><button type=\"submit\" name=\"order_by\" value=\"o.supplier_staff_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.supplier_staff_cd DESC\">↑</button></th>";
								// echo "<th>担当者名<br><button type=\"submit\" name=\"order_by\" value=\"mst.staff_name ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"mst.staff_name DESC\">↑</button></th>";
								echo "<th>仕入先CD<br><button type=\"submit\" name=\"order_by\" value=\"o.supplier_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.supplier_cd DESC\">↑</button></th>";
								echo "<th>仕入先名<br><button type=\"submit\" name=\"order_by\" value=\"msp.supplier_name ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"msp.supplier_name  DESC\">↑</button></th>";
								// echo "<th>支払先CD<br><button type=\"submit\" name=\"order_by\" value=\"o.payee_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.payee_cd DESC\">↑</button></th>";
								// echo "<th>支払先名<br><button type=\"submit\" name=\"order_by\" value=\"mpy.payee_name ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"mpy.payee_name DESC\">↑</button></th>";
								// echo "<th>支払帳端区分<br><button type=\"submit\" name=\"order_by\" value=\"o.payment_kbn ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.payment_kbn DESC\">↑</button></th>";
								// echo "<th>支払予定日<br><button type=\"submit\" name=\"order_by\" value=\"o.payment_date ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.payment_date DESC\">↑</button></th>";
								// echo "<th>支払方法CD<br><button type=\"submit\" name=\"order_by\" value=\"o.payment_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.payment_cd DESC\">↑</button></th>";
								// echo "<th>支払方法<br><button type=\"submit\" name=\"order_by\" value=\"mpm.payment_name ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"mpm.payment_name DESC\">↑</button></th>";
								// echo "<th>仕入先注文番号<br><button type=\"submit\" name=\"order_by\" value=\"o.supplier_order_no ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.supplier_order_no DESC\">↑</button></th>";
								// echo "<th>案件番号<br><button type=\"submit\" name=\"order_by\" value=\"o.demand_no ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.demand_no DESC\">↑</button></th>";
								// echo "<th>配送業者CD<br><button type=\"submit\" name=\"order_by\" value=\"o.hauler_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.hauler_cd DESC\">↑</button></th>";
								// echo "<th>配送業者名<br><button type=\"submit\" name=\"order_by\" value=\"mh.hauler_name ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"mh.hauler_name DESC\">↑</button></th>";
								echo "<th>伝票摘要<br><button type=\"submit\" name=\"order_by\" value=\"o.slip_remarks ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.slip_remarks  DESC\">↑</button></th>";
								// echo "<th>発注書摘要<br><button type=\"submit\" name=\"order_by\" value=\"o.order_remarks ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.order_remarks DESC\">↑</button></th>";
								// echo "<th>発注書不要フラグ<br><button type=\"submit\" name=\"order_by\" value=\"o.slip_not_use_flg ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.slip_not_use_flg DESC\">↑</button></th>";
								// echo "<th>発注書発行対象フラグ<br><button type=\"submit\" name=\"order_by\" value=\"o.order_print_flg ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.order_print_flg DESC\">↑</button></th>";
								// echo "<th>発注書即伝発行フラグ<br><button type=\"submit\" name=\"order_by\" value=\"o.ex_order_flg ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.ex_order_flg DESC\">↑</button></th>";
								// echo "<th>発注書摘要発行日時<br><button type=\"submit\" name=\"order_by\" value=\"o.print_timestamp ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.print_timestamp DESC\">↑</button></th>";
								// echo "<th>入荷完了区分<br><button type=\"submit\" name=\"order_by\" value=\"o.arrived_kbn ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.arrived_kbn DESC\">↑</button></th>";
								// echo "<th>仕入完了区分<br><button type=\"submit\" name=\"order_by\" value=\"o.purchased_kbn ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.purchased_kbn DESC\">↑</button></th>";
								// echo "<th>商品状態区分<br><button type=\"submit\" name=\"order_by\" value=\"o.approval_status_kbn ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.approval_status_kbn DESC\">↑</button></th>";
								// echo "<th>作成担当者CD<br><button type=\"submit\" name=\"order_by\" value=\"o.created_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.created_cd DESC\">↑</button></th>";
								// echo "<th>作成日時<br><button type=\"submit\" name=\"order_by\" value=\"o.created_timestamp ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.created_timestamp DESC\">↑</button></th>";
								// echo "<th>更新担当者CD<br><button type=\"submit\" name=\"order_by\" value=\"o.modified_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.modified_cd DESC\">↑</button></th>";
								// echo "<th>更新日時<br><button type=\"submit\" name=\"order_by\" value=\"o.modified_timestamp ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"o.modified_timestamp DESC\">↑</button></th>";
								// echo "<th>伝票番号<br><button type=\"submit\" name=\"order_by\" value=\"od.order_slip_no ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.order_slip_no DESC\">↑</button></th>";
								echo "<th>行<br><button type=\"submit\" name=\"order_by\" value=\"od.order_detail_no ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.order_detail_no  DESC\">↑</button></th>"; // 明細行番号
								echo "<th>商品CD<br><button type=\"submit\" name=\"order_by\" value=\"CASE WHEN od.item_cd~ '^D[0-9]{1,}' THEN 'D' || TO_CHAR(CAST(REPLACE( od.item_cd ,'D' ,'' ) AS INTEGER),'FM000000') ELSE od.item_cd ASC END\">↓</button><button type=\"submit\" name=\"order_by\" value=\"CASE WHEN od.item_cd~ '^D[0-9]{1,}' THEN 'D' || TO_CHAR(CAST(REPLACE( od.item_cd ,'D' ,'' ) AS INTEGER),'FM000000') ELSE od.item_cd DESC END\">↑</button></th>";
								...
								echo "<th>商品名補足<br><button type=\"submit\" name=\"order_by\" value=\"od.model_name ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.model_name  DESC\">↑</button></th>"; // 規格
								echo "<th>発注数<br><button type=\"submit\" name=\"order_by\" value=\"od.order_qty ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.order_qty  DESC\">↑</button></th>";
								// echo "<th>仮単価区分<br><button type=\"submit\" name=\"order_by\" value=\"od.temporary_price_kbn ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.temporary_price_kbn DESC\">↑</button></th>";
								// echo "<th>仕入単価<br><button type=\"submit\" name=\"order_by\" value=\"od.purchase_cost ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.purchase_cost DESC\">↑</button></th>";
								// echo "<th>仕入金額<br><button type=\"submit\" name=\"order_by\" value=\"od.purchase_amount ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.purchase_amount DESC\">↑</button></th>";
								// echo "<th>仕入消費税額<br><button type=\"submit\" name=\"order_by\" value=\"od.purchase_consumption_tax ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.purchase_consumption_tax DESC\">↑</button></th>";
								// echo "<th>明細仕入先注文番号<br><button type=\"submit\" name=\"order_by\" value=\"od.payee_order_no ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.payee_order_no DESC\">↑</button></th>";
								// echo "<th>明細入荷予定日<br><button type=\"submit\" name=\"order_by\" value=\"od.arrival_ex_ymd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.arrival_ex_ymd DESC\">↑</button></th>";
								// echo "<th>明細仕入予定日<br><button type=\"submit\" name=\"order_by\" value=\"od.purchase_ex_ymd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.purchase_ex_ymd DESC\">↑</button></th>";
								// echo "<th>明細摘要<br><button type=\"submit\" name=\"order_by\" value=\"od.remarks ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.remarks DESC\">↑</button></th>";
								// echo "<th>入荷完了区分<br><button type=\"submit\" name=\"order_by\" value=\"od.arrived_kbn ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.arrived_kbn DESC\">↑</button></th>";
								echo "<th>完納<br><button type=\"submit\" name=\"order_by\" value=\"od.purchased_kbn ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.purchased_kbn  DESC\">↑</button></th>";
								// echo "<th>入荷予定数<br><button type=\"submit\" name=\"order_by\" value=\"od.arrival_ex_qty ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.arrival_ex_qty DESC\">↑</button></th>";
								// echo "<th>入荷数<br><button type=\"submit\" name=\"order_by\" value=\"od.arrival_qty ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.arrival_qty DESC\">↑</button></th>";
								echo "<th>仕入済／<br>発注残<br><button type=\"submit\" name=\"order_by\" value=\"od.purchase_qty ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.purchase_qty  DESC\">↑</button></th>";
								// echo "<th>取消フラグ<br><button type=\"submit\" name=\"order_by\" value=\"od.cancel_flg ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.cancel_flg DESC\">↑</button></th>";
								// echo "<th>作成担当者CD<br><button type=\"submit\" name=\"order_by\" value=\"od.created_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.created_cd DESC\">↑</button></th>";
								// echo "<th>作成日時<br><button type=\"submit\" name=\"order_by\" value=\"od.created_timestamp ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.created_timestamp DESC\">↑</button></th>";
								// echo "<th>更新担当者CD<br><button type=\"submit\" name=\"order_by\" value=\"od.modified_cd ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.modified_cd DESC\">↑</button></th>";
								// echo "<th>更新日時<br><button type=\"submit\" name=\"order_by\" value=\"od.modified_timestamp ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"od.modified_timestamp DESC\">↑</button></th>";
								echo "<th>倉庫名<br><button type=\"submit\" name=\"order_by\" value=\"ms.shop_short_name ASC\">↓</button><button type=\"submit\" name=\"order_by\" value=\"ms.shop_short_name DESC\">↑</button></th>";
								echo "</tr>";
								...
								while ( $row = pg_fetch_assoc ( $res ) ) {
									...
									$approval_status_kbn = ( string ) $row ['approval_status_kbn'];
									...
									$d_stocked_kubun_cd = ( string ) $row ['d_stocked_kubun_cd'];
									$d_purchased_kubun_cd = ( string ) $row ['d_purchased_kubun_cd'];
									...
									echo "<td>$slip_summary</td>";
										...
										// echo "<td>$approval_status_kbn</td>";
									...
									// echo "<td>$d_stocked_kubun_cd</td>";
									echo "<td>$d_purchased_kubun_cd</td>";
